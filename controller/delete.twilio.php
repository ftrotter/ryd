...
";
		...
		$this->xml .= "
<Response>
  <Gather action='$base_url"."twilio.php/delete/choose'  method='POST'>
        <Say voice='man'>
            You must have a pin code to delete messages.
...
";
    ...
    <Say>You do not have any recordings yet. Call the record phone number to create some.</Say>
		...
		$this->xml .= "
<Response>
  <Gather action='$base_url"."twilio.php/delete/play?pin_code=$pin_code'  method='POST'>
        <Say voice='man'>
            You have $count recordings. 
	    Please use your keypad to enter the number of the recording you would like to delete, at any time, by entering the number followed by the pound sign.
	</Say>
	<Pause length='2'/>
";
...
/**
 * play. allows twilio to play a given recording.. 
 */
	function play(){
...
";
			...
			$redirect_url = $url."twilio.php/delete/delete?pin_code=$pin_coder&amp;rec_id=$recording_id_chosen";
...
<Response>
 <Gather action='$base_url"."twilio.php/delete/play?pin_code=$pin_code' method='POST'>
        <Say voice='man'>
            Are you sure you want to delete recording $human_number? We will play message number $human_number. If you would like to delete the message, press five at any time. Otherwise press one.
	</Say>
...
";
			...
			$url = $GLOBALS['base_url'];
			$redirect_url = $url."twilio.php/delete/delete?pin_code=$pin_code";
